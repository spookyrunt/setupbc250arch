# setupbc250arch
Run both scripts one by one after [BIOS flashing](https://elektricm.github.io/amd-bc250-docs/bios/flashing)[^1][^2][^3] on Arch Linux. This project includes two BC-250 install scripts setting up:
